...
import { acLogo, cross, menuBurger } from '../assets'
...
const Nav = () => {
  ...
  return (
    <header className='bg-white'>
        <div className={toggle?'transition-[height] ease-in-out delay-150 h-[100vh]':'transition-[height] ease-in-out delay-150 h-[92px]'}>
